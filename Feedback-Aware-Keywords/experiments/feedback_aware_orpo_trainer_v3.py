...
class FeedbackAwareORPOTrainerv3(ORPOTrainer):
    ...
    def _tokenize_function(self, examples):
        inputs = self.processing_class(examples, add_special_tokens=False)
    ...
    def build_tokenized_answer(self, prompt, answer):
        ...
        #prompt_input_ids = self.processing_class(' '.join(word_tokenize(prompt)), add_special_tokens=False)["input_ids"]
    ...
    def tokenize_row(self, feature, model: Optional[Union[PreTrainedModel, nn.Module]] = None) -> Dict:
        ...
        if not self.is_encoder_decoder:
            ...
            prompt_tokens = self.processing_class(' '.join(word_tokenize(prompt)), add_special_tokens=False)
