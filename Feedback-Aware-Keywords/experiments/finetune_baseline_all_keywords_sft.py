...
from prepare_dataset_keywords import get_dataset_baseline_all_keywords_sft
...
wandb.init(
    ...
    config={
        ...
        'task': 'V2, Keywords, All Keywords Generation, LoRA, Half, SFT',
    }
)

data_train, data_test, _ = get_dataset_baseline_all_keywords_sft()
...
new_model_name = "llama3_8b_keywords_baseline_all_keywords_generation_lw"
