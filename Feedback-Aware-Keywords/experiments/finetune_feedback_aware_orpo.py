...
import wandb
import random
from prepare_dataset_keywords import get_dataset_keywords_feedback_aware_orpo_v4
...
wandb.init(
    ...
    config={
        ...
        'task': 'Keywords, Feedback Aware V4, ORPO, Beta 0.3',
    }
)

data_train, data_test = get_dataset_keywords_feedback_aware_orpo_v4()

model_name = "meta-llama/Meta-Llama-3-8B"
new_model_name = "llama3_8b_keywords_feedback_aware_orpo_final_lw"
...
dpo_trainer = FeedbackAwareORPOTrainerv3(
    ...
    args=ORPOConfig(
        ...
        optim="adamw_8bit",
        report_to="wandb",
        output_dir="orpo_logs_lora_half_beta_03_h100",
        save_strategy="steps",
        save_steps=0.1,
        save_total_limit=1,
        max_length=3000,
