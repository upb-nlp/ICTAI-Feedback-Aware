...
model_name = "llama3_8b_keywords_baseline_all_keywords_generation_whole_dataset"
...
def get_next_prompt(prompt, keyword):
...
for data in tqdm(data_test):
    ...
    while iter < max_iter:
        ...
        try:
            ...
            prompt = get_next_prompt(prompt, keyword)
        except Exception as e:
            print(e)
            break
    test_generated_list.append(gen_list)

json.dump(test_generated_list, open(f"Feedback-Aware-Keywords/experiments/test_keywords_baseline_all_keywords_sft_smart_duplicates_whole_dataset_chunk.json", 'w'), indent=4)
