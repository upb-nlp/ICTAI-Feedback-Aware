...
filenames = {
    f"Feedback-Aware-Keywords/experiments/test_keywords_feedback_aware_sft_smart_duplicates.json": "FA (ours)",
    f"Feedback-Aware-Keywords/experiments/test_keywords_baseline_single_keyword_sft_smart_duplicates.json": "SSG",
    f"Feedback-Aware-Keywords/experiments/test_keywords_baseline_all_keywords_sft_smart_duplicates.json": "ASG",
    #f"Feedback-Aware-Keywords/experiments/test_keywords_all_gpt4omini_one_shot.json": "All GPT-4o-mini One Shot",
    f"Feedback-Aware-Keywords/experiments/test_keywords_all_gpt4o_one_shot.json": "GPT-4o",
}
...
fig_precision.write_image("Feedback-Aware-Keywords/experiments/keywords_main_results.png")