...
# Declaring index
hnsw_index = hnswlib.Index(space='cosine', dim=dim)  # possible options are l2, cosine or ip
...
hnsw_index.init_index(max_elements=num_elements, ef_construction=200, M=64)
