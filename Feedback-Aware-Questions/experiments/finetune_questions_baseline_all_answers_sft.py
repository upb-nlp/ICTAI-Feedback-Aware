...
from prepare_dataset_questions import get_dataset_questions_all_answers_sft
...
wandb.init(
    ...
    config={
        ...
        'task': 'Questions, All Answers, SFT',
    }
)

data_train, data_test, _ = get_dataset_questions_all_answers_sft()
...
new_model_name = "llama3_8b_questions_baseline_all_answers_sft_lw"
