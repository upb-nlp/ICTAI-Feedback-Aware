...
from prepare_dataset_questions import get_dataset_questions_baseline_single_answer_sft
...
wandb.init(
    ...
    config={
        ...
        'task': 'Questions, Single Answer, SFT',
    }
)

data_train, data_test = get_dataset_questions_baseline_single_answer_sft()
...
new_model_name = "llama3_8b_questions_baseline_single_answer_sft_lw"
