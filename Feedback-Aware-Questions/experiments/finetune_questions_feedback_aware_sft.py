...
from prepare_dataset_questions import get_dataset_questions_feedback_aware_sft_v4
import copy
...
wandb.init(
    ...
    config={
        ...
        'task': 'Questions, Feedback Aware, SFT',
    }
)

model_name = "meta-llama/Meta-Llama-3-8B"

new_model_name = "llama3_8b_questions_feedback_aware_sft_lw"

tokenizer = AutoTokenizer.from_pretrained(model_name, padding_side="left", token='TOKEN_KEY')
tokenizer.pad_token_id = 128002

data_train, data_test = get_dataset_questions_feedback_aware_sft_v4()
