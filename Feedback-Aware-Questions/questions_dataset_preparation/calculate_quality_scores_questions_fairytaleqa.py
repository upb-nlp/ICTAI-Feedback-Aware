...
#start, end = (0, 3300)
#start, end = (3300, 6600)
#start, end = (6600, 10000)

dataset = json.load(open(f'Failed-EMNLP/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_answers_questions.json'))
...
json.dump(dataset, open(f'Failed-EMNLP/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_answers_questions_quality_scores_sum_no_context.json', 'w'), indent=4)