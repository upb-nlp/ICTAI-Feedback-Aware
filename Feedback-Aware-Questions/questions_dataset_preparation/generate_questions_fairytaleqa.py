...
dataset = json.load(open(f"Failed-EMNLP/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_syntax_tree.json", 'r'))
batch_size = 8
...
json.dump(dataset, open(f"Failed-EMNLP/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_answers_questions.json", 'w'), indent=4)