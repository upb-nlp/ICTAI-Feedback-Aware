...
for PARTITION in ['train', 'test', 'val']:
    dataset = json.load(open(f"Failed-EMNLP/tasa_dataset_preparation/tasa_{PARTITION}.json", 'r'))
    ...
    json.dump(dataset, open(f"Failed-EMNLP/tasa_dataset_preparation/tasa_{PARTITION}_syntax_tree.json", 'w'), indent=4)